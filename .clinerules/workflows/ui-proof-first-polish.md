...
2. Doe eerst een shared fit check: bestaand scaffold/component gebruiken of uitbreiden vóór screen-local code.
3. Identificeer of oorzaak in screen-assembly of shared primitive-default zit.
4. Pas de kleinste clean-first, mode-aware fix toe.
5. Controleer impact op aangrenzende schermen met dezelfde primitive.
6. Run verify en doe light/dark proof-check.
