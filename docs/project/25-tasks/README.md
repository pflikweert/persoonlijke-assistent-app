...
| [Productieflow Data opnieuw verwerken bronconsistentie](open/productieflow-data-opnieuw-verwerken-bronconsistentie.md) | p1 | transitiemaand-consumer-beta | Admins kunnen productie veilig read-only auditen, daarna entries, dagjournals, weekreflecties en maandreflecties in correcte volgorde her... |
...
| [Admin + AIQS Linear interface kit refresh](done/admin-aiqs-linear-interface-kit-refresh.md) | p1 | transitiemaand-consumer-beta | Budio admin en AIQS gebruiken een gedeelde admin-console componentlaag die desktop/tablet/mobile beter ondersteunt, zonder routes, datafl... |
...
| [Admin/founder meeting capture — web route en IA](done/admin-founder-meeting-capture-web-route-en-ia.md) | p1 | transitiemaand-consumer-beta | Er is een admin-only ingang naar een Meeting Capture overzicht, een nieuwe-opname route en een detailroute. Niet-admin gebruikers zien de... |
| [AIQS admin console UI/UX Linear-richting](done/aiqs-admin-console-uiux-linear-richting.md) | p1 | transitiemaand-consumer-beta | De admin- en AIQS-interface krijgt een eigen look and feel die past bij admin tooling en visueel richting Linear beweegt: rustige toolbar... |
...
| [AIQS draft-live promotie en rollback flow](done/aiqs-draft-live-promotie-en-rollback-flow.md) | p1 | transitiemaand-consumer-beta | Een AIQS-admin kan vanuit de bestaande admin-console zien welke versie live is, welke draft nog bewijs mist, welke draft klaar is voor li... |
...
| [AIQS runtime DB-binding voor live prompts](done/aiqs-runtime-db-binding-voor-live-prompts.md) | p1 | transitiemaand-consumer-beta | Voor alle huidige AIQS-managed families leest runtime zijn prompt/model/system/config uit live AIQS-versies in de database. De app gebrui... |
...
| [Plan Mode task auto-create bij ontbrekende match](done/plan-mode-task-auto-create-bij-ontbrekende-match.md) | p1 | transitiemaand-consumer-beta | Plan Mode werkt voortaan met een goedkope en consistente preflight: - eerst zoeken naar een passende bestaande task - bij duidelijke matc... |
...
| [AIQS admin-interface thema herontwerp (Spotify/OpenAI stijl)](done/aiqs-admin-interface-thema-herontwerp-spotify-openai-stijl.md) | p2 | transitiemaand-consumer-beta | AIQS admin krijgt een eigen, heldere en strakke visuele stijl binnen Budio, geïnspireerd door Spotify Creator Tool en OpenAI admin-tools.... |
...
| [Capture tekstinvoer copy en spacing polish](done/capture-tekstinvoer-copy-en-spacing-polish.md) | p2 | transitiemaand-consumer-beta | De tekstinvoerweergave toont direct onder de bestaande header alleen de functionele datumcontext, daarna het tekstveld, tekenteller en `L... |
...
| [Dag/week/maand swipe navigatie](done/dag-week-maand-swipe-navigatie.md) | p2 | transitiemaand-consumer-beta | Dagdetail, weekreflectie en maandreflectie ondersteunen dezelfde swipe-interactie als momentdetail: links naar de volgende bestaande pagi... |
| [Dagdetail empty state en reflectieblokken verwijderen](done/dagdetail-empty-state-en-reflectieblokken-verwijderen.md) | p2 | transitiemaand-consumer-beta | Een lege dag toont compact `Nog geen momenten`, `Er is voor deze dag nog niets vastgelegd.` en de knop `Moment toevoegen`. Dagdetail toon... |
| [Dagdetail momenten sectietitel verkorten](done/dagdetail-momenten-sectietitel-verkorten.md) | p2 | transitiemaand-consumer-beta | Op dagdetail heet de gevulde momenten-sectie `Momenten`. |
| [Dagenoverzicht lege dagen openen en moment toevoegen](done/dagenoverzicht-lege-dagen-openen-en-moment-toevoegen.md) | p2 | transitiemaand-consumer-beta | `/days` toont tussen de geladen echte dagjournals ook subtiele lege kalenderdagen. Een lege rij is klikbaar, opent `/day/YYYY-MM-DD`, too... |
...
| [Momentdetail swipe body gesture fix](done/moment-detail-swipe-body-gesture-fix.md) | p2 | transitiemaand-consumer-beta | Horizontale swipe-navigatie werkt op de inhoud van de momentdetailpagina en blijft uitgeschakeld op foto-interactiegebieden. |
| [Momentdetail swipe navigatie](done/moment-detail-swipe-navigatie.md) | p2 | transitiemaand-consumer-beta | De momentdetailpagina ondersteunt swipe links/rechts voor volgend/vorig moment. Als er geen moment in die richting bestaat, beweegt de pa... |
| [Momentdetail swipe runtime fix](done/moment-detail-swipe-runtime-fix.md) | p2 | transitiemaand-consumer-beta | Swipen links/rechts werkt lokaal op de momentdetailpagina en is zelf getest met runtime-bewijs. |
| [Momentdetail swipe scroll regressie fix](done/moment-detail-swipe-scroll-regressie-fix.md) | p2 | transitiemaand-consumer-beta | De pagina scrolt weer normaal verticaal. Horizontale swipe blijft werken op gewone content, en foto’s/fotopopups blijven uitgesloten. |
...
| [Swipe scroll regressie tekst/content](done/swipe-scroll-regressie-tekst-content.md) | p2 | transitiemaand-consumer-beta | Gebruikers kunnen vanaf tekst en midden van de pagina normaal verticaal scrollen op momentdetail, dagdetail, weekreflectie en maandreflec... |
| [Taskflow closeout en agentmetadata hardening](done/taskflow-closeout-agentmetadata-hardening.md) | p2 | transitiemaand-consumer-beta | Task-closeout wordt consequent: afgeronde taken staan in `done/`, hebben `status: done`, geen live `active_agent*` metadata, en behouden... |
