...
| [Archief-import actieve voortgang zonder preview-duplicatie](open/archief-import-actieve-voortgang-zonder-preview-duplicatie.md) | p2 | transitiemaand-consumer-beta | Na het starten van een archief-import blijft het preview-scherm zichtbaar terwijl tegelijk een voortgangsblok verschijnt. Daardoor toont... |
