...
| [Admin/founder meeting capture — scope en eerste versie vastleggen](open/admin-founder-meeting-capture-scope-en-eerste-versie-vastleggen.md) | p1 | transitiemaand-consumer-beta | De scope voor v1 staat scherp: admin/founder-only, audio-safe web recording, buiten dagboekcapture, met transcriptie en insights als late... |
