...
export type PeriodScopeSelectorTab = "day" | "week" | "month";

type PeriodScopeSelectorModalProps = {
  visible: boolean;
  activeTab: PeriodScopeSelectorTab;
  onClose: () => void;
  onChangeTab: (tab: PeriodScopeSelectorTab) => void;
  dayLoading: boolean;
...
export function PeriodScopeSelectorModal({
  visible,
  activeTab,
  onClose,
  onChangeTab,
  ...
  monthError,
  months,
  subtitle = "Selecteer dag, week of maand.",
  emptyDetail = "Leg eerst iets vast, dan verschijnen je opties hier.",
  onSelectDay,
  onSelectWeek,
  onSelectMonth,
}: PeriodScopeSelectorModalProps) {
