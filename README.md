...
- Edge Function vars: `OPENAI_API_KEY` (vereist), `OPENAI_MODEL` (optioneel).
...
## Fase 1: text intake edge function
- Functiepad: `supabase/functions/process-entry`.
- Input: `{ "rawText": "..." , "capturedAt"?: "ISO-8601" }`.
- Output: `rawEntryId`, `normalizedEntryId`, `journalDate`, `dayJournalId`, `status`.
