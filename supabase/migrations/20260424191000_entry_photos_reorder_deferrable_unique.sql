alter table public.entry_photos
  drop constraint if exists entry_photos_raw_entry_id_sort_order_key;

alter table public.entry_photos
  add constraint entry_photos_raw_entry_id_sort_order_key
...
begin
  ...
  set constraints entry_photos_raw_entry_id_sort_order_key deferred;
