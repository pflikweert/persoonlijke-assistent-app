...
export const REFLECTION_PROMPT_VERSION = "period-reflection.v1.phase4.4";
...
export function buildReflectionPromptSpec(input: {
  ...
  const periodSpecificGuidance =
    input.periodType === "week"
      ? "Weekreflectie: benoem de belangrijkste terugkerende lijn van de week. Kies alleen de momenten die die week het duidelijkst bepaalden. Vermijd dag-voor-dag recap en vermijd verhalende weekopbouw."
      : "Maandreflectie: benoem de belangrijkste ontwikkeling of terugkerende lijn van de maand. Kies alleen de momenten die die maand het duidelijkst markeren. Vermijd week-op-week recap, logboekstructuur en te veel gecomponeerde maandtaal.";
