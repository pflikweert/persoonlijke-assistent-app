...
export const REFLECTION_PROMPT_VERSION = "period-reflection.v1.phase4.5";
...
const REFLECTION_SYSTEM_PROMPT =
  "Maak een compacte, brongebonden periodereflectie op basis van day journals. Kies selectie boven volledigheid: vat niet alles samen, maar benoem alleen wat de periode echt typeert. Schrijf sober, direct, concreet, menselijk, schermklaar en in natuurlijk Nederlands. Prefer clarity over beauty. Prefer direct phrasing over reflective or literary phrasing. Avoid symbolic, poetic or essay-like transitions. Keep wording modest and understated. Write for quick rereading on a screen. De toon is precies en rustig, niet rapportachtig, niet meta, niet generiek-AI, niet coachend en niet lifestyle-editorial. Geen therapietaal, diagnostische taal, managementtoon, checklisttoon of dag-voor-dag verslag tenzij een moment de periode echt bepaalt. Voorkom laaglekkage: gebruik geen day-section labels of gerecyclede dagblokken als periodereflectie. Gebruik geen vragen in de output. Geef alleen JSON terug met summaryText, narrativeText, highlights en reflectionPoints.";
...
export function buildReflectionPromptSpec(input: {
  ...
  const periodSpecificGuidance =
    input.periodType === "week"
      ? "Weekreflectie: benoem de belangrijkste terugkerende lijn van de week. Kies alleen de momenten die die week het duidelijkst bepaalden. Noem minstens een keer expliciet een patroon, verschuiving, spanning, ritme, thema of terugkerende lijn als die in de bron aantoonbaar is. Vermijd dag-voor-dag recap en vermijd verhalende weekopbouw."
      : "Maandreflectie: benoem de belangrijkste ontwikkeling of terugkerende lijn van de maand. Kies alleen de momenten die die maand het duidelijkst markeren. Noem minstens een keer expliciet een patroon, verschuiving, spanning, ritme, thema of terugkerende lijn als die in de bron aantoonbaar is. Vermijd week-op-week recap, logboekstructuur en te veel gecomponeerde maandtaal.";
  ...
  return {
    ...
    userPrompt: JSON.stringify({
      instruction:
        "Gebruik alleen de meegegeven day journals (summary, narrative_text, sections). Schrijf een periodereflectie die selecteert in plaats van volledig samen te vatten. summaryText: 1-3 zinnen, kort en typerend. Use plain language. Avoid abstract framing. Do not sound like an introduction to an essay. Make it readable at a glance. Geen recap, geen overlap met reflectionPoints en geen slimme opener. Als er een duidelijke terugkerende lijn, verschuiving, spanning, ritme of thema zichtbaar is, benoem die compact en expliciet. narrativeText: compacte periodetekst, geen verhalende mini-essaytekst. Norm: 2-3 korte alinea's. Schrijf direct, rustig en concreet. Benoem alleen de hoofdlijn en de belangrijkste concrete momenten. Geen sfeerzinnen, geen mooie brugzinnen, geen symbolische overgangen en geen formuleringen met meer stijl dan informatie. Liever soberder dan te mooi. Do not write like a columnist, essayist or therapist. Avoid poetic transitions. Avoid elegant but low-information sentences. Prefer concrete source reality over atmospheric phrasing. Write for someone rereading quickly on a phone. Keep paragraphs short. Prefer short sentences. Each paragraph should add clear information. Remove decorative wording. highlights: 2-6 korte, concrete gebeurtenissen die de periode echt markeren. Elk item benoemt precies 1 moment of 1 kleine cluster met een duidelijk gezamenlijk zwaartepunt. Geen verzamelzin en geen mini-samenvatting van losse dingen, tenzij het echt 1 cluster is. Streef per highlight naar 12-20 woorden met een harde bovengrens van 25 woorden. Geen labels of prefixes zoals Inzicht:, Ochtend:, Middag:, Avond:, Maandag:, Dinsdag:, Woensdag:, Donderdag:, Vrijdag:, Zaterdag:, Zondag:. Geen fallback-zinnen zoals Dit thema kwam meerdere keren terug. Geen afgekapt of half opgebroken zinnen. reflectionPoints: 2-5 korte, precieze, brongebonden observaties. Lichte herkenning mag alleen als die direct rust op terugkerende bronmomenten. Geen algemene wijsheden, geen projectieve psychologische duiding en geen formulering die op bijna iedereen toepasbaar is. Do not use broad human-truth phrasing unless it is clearly anchored in repeated source content. Avoid horoscope-like recognition. Avoid therapist-like or quasi-deep phrasing. Elk punt bevat precies 1 gedachte over patroon, spanning, contrast, verschuiving of ritme. Minstens 1 punt benoemt expliciet een patroon, thema, verschuiving, spanning, ritme of terugkerende lijn als dat brongebonden aantoonbaar is. Streef per reflectiepunt naar 10-20 woorden met een harde bovengrens van 30 woorden. Geen vraagvorm, geen checklist, geen advies, geen grote metaforen en geen interpretatie die groter is dan de bron. Vermijd expliciet rapportzinnen en stock-openers zoals De week draaide vooral om..., De maand draaide vooral om..., Er was veel aandacht voor..., Naast X was er ook..., Wat zichtbaar werd..., Langzaam ontstond..., Tegelijk tekende zich af..., De maand kreeg..., Onder dit alles speelde..., Er ontstond meer ruimte voor..., De blik ging al naar..., Deze maand liet zien dat... en Daar doorheen liep.... Geen aannames buiten de input, geen therapie- of diepteduiding, geen meta-zinnen over aantallen day journals en geen halve of afgebroken zinnen.",
