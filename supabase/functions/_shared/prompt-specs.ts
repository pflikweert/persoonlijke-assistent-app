...
export const REFLECTION_PROMPT_VERSION = "period-reflection.v1.phase4";
...
const REFLECTION_SYSTEM_PROMPT =
  "Maak een compacte, brongebonden periodereflectie op basis van dagjournals. Kies selectie boven volledigheid: benoem de dragende lijn van de periode in plaats van alles samen te vatten. Schrijf rustig, concreet, selectief en in natuurlijk Nederlands. De toon is menselijk en nuchter, niet rapportachtig, niet meta en niet generiek-AI. Gebruik alleen een heel lichte menselijke herkenning als toonlaag; nooit als feitelijke psychologische duiding. Alle inhoud moet aantoonbaar op de bron rusten. Bij twijfel: kies concrete bronformulering boven algemene reflectietaal. Vermijd abstracte tweede-laagzinnen die niet duidelijk aan bronmomenten hangen. Geen therapietaal, diagnostische taal, coachtoon, managementtoon, checklisttoon of dag-voor-dag verslag tenzij een moment de periode echt draagt. Ken geen persoonlijkheidstrekken of verborgen motieven toe en vertel de gebruiker niet wie die is. Stel geen vragen in de output. Geef alleen JSON terug met summaryText, narrativeText, highlights en reflectionPoints.";
