...
immediate usability 2. Product Hierarchy Rules (NEW — CRITICAL)
Today Screen Rules
...
Principle
“The user must feel: I can start immediately.” 3. Color & Tonal Architecture
...
Separation via tonal shifts only 4. Typography: Editorial, but Functional
Font: Inter / SF Pro
Headlines
...
Used sparingly
NEW RULE
On entry screens: clarity > reading experience 5. Layout & Spacing
Core Principle
We design in flow, not stacked cards.
Avoid
...
avoid “empty but meaningless” space 6. Elevation & Depth
Tonal layering (kept)
...
used sparingly
NEW RULE
Depth is used to support interaction, not decoration 7. Components
...
typing and voice handled in next screen 8. Motion & Interaction
Purpose
Motion should:
...
unnecessary motion 9. Do’s and Don’ts
Do
...
don’t let reflection dominate entry screens 10. Final Principle
